...
// coordenadas e em torno do eixo X (primeiro vetor da base do sistema de coordenadas).
glm::mat4 Matrix_Rotate_X(float angle);

// Matriz R de "rotação de um ponto" em relação à origem do sistema de
// coordenadas e em torno do eixo Y (segundo vetor da base do sistema de coordenadas).
glm::mat4 Matrix_Rotate_Y(float angle);

// Matriz R de "rotação de um ponto" em relação à origem do sistema de
// coordenadas e em torno do eixo Z (terceiro vetor da base do sistema de coordenadas).
